...
trait Jump
{
    ...
    {
        $resDataBody = [];
        $resDataBody['data'] = empty($data) ? [] : $data['data'];
        $resDataBody['header'] = empty($header) ? [] : $header;
        $responseData = [
            "code" => $code,
    ...
    {
        return $this->jsonReturn($data, $msg, SUCC_CODE);
    }
     ...
     * @author Bill
     */
    public function errReturn($msg = '', $data = [])
    {
        return $this->jsonReturn($data, $msg, ERR_CODE);
    }
     ...
     * @author Bill
     */
    public function excepReturn($msg = '', $data = [])
    {
        return $this->jsonReturn($data, $msg, EXECP_CODE);
    }
