...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'WVjgK>xnrXz%Y:H)iZ^y".AId0-2u*R[FN6G1~D<', //默认数据加密KEY
	'data_cache_key'=> 'WVjgK>xnrXz%Y:H)iZ^y".AId0-2u*R[FN6G1~D<',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'WVjgK>xnrXz%Y:H)iZ^y".AId0-2u*R[FN6G1~D<', //加密KEY
